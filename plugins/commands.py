...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/SMKEYSUPDATES')
            ],
            [
                InlineKeyboardButton('🙆🏻 Help 🦾', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('⪦ TALK WITH OUR ASISTANT ⪧', url='https://t.me/ITACHI_FT_SMK_BOTZ')
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("Hey Bro, Just Check one time that i am added in main channel or not...!")
            return
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 Maurya Universal bot support 🦋", url='https://t.me/Maurya_Universal_bot_support'
                )
            ]
        ]
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        [
            InlineKeyboardButton('⪦  ⪧', url='https://t.me/SMKEYSUPDATES')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
            photo=random.choice(PICS),
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You SMK's BOTZ ♥️')
